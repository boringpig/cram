...
@section('page-title', '新增事件')

@section('content')
    <div class="row">
        <div class="col-sm-9 col-sm-offset-3">
            {!! Form::model($event = new App\Models\CalendarEvent, ['route' => ['backend.calendar_events.store'], 'method' => 'post' , 'class' => 'horizontal']) !!}
                @include('admin.calendar_events.partials._form', ['submitButtonText' => '建立'])
            {!! Form::close() !!}
        </div>
    </div>
@endsection
